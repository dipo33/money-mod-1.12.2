...
public abstract class Thunderbolt {
	 ...
	 * <p>
	 * NOTE: Make sure to call {@link Thunderbolt#unload(String)} when you're done
	 * using this file, otherwise a memory leak may occur!
	 * 
	...
	public static void unload(String name) {
		...
		if (file == null) {
			new FileNotFoundException("[Thunderbolt] The file '" + name + ".json' isn't loaded and/or doesn't exist.").printStackTrace();
		}
	}
